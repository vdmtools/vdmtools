...
// a typedef is less sweeping than a #define for L"bool"
...
//
friend class basic_wstring<charT>;
...
//
    ...
    basic_string_ref (const basic_wstring<charT>& str, size_t pos , size_t rlen)
                      _THROW_ALLOC ;
...
protected:
    ...
    basic_wstring (const charT* s, size_t rlen, size_t xlen) _THROW_ALLOC_LENGTH;
...
public:
    ...
    basic_wstring () _THROW_ALLOC ;

    basic_wstring (size_t size, capacity cap) _THROW_ALLOC_LENGTH ;

    basic_wstring (const basic_wstring<charT>& str, size_t pos = 0, size_t n = NPOS)
                  _THROW_ALLOC_OUTRANGE ;

    basic_wstring (const charT* s, size_t n) _THROW_ALLOC_LENGTH ;

    basic_wstring (const charT* s) _THROW_ALLOC ;

    basic_wstring (charT c, size_t rep = 1) _THROW_ALLOC_LENGTH ;

    basic_wstring (const vector<charT>& vec) _THROW_ALLOC_LENGTH ;

    ~basic_wstring () _THROW_NONE ;

    basic_wstring<charT>&
    operator= (const basic_wstring<charT>& str) _THROW_ALLOC ;
    ...
    basic_wstring<charT>&
    operator+= (const basic_wstring<charT>& rhs) _THROW_ALLOC_LENGTH ;
    ...
    basic_wstring<charT>&
    append (const basic_wstring<charT>& str, size_t pos = 0, size_t n = NPOS)
            _THROW_ALLOC_LENGTH_OUTRANGE ;
    ...
    basic_wstring<charT>&
    assign (const basic_wstring<charT>& str, size_t pos = 0, size_t n = NPOS)
            _THROW_ALLOC_LENGTH_OUTRANGE ;
    ...
    basic_wstring<charT>&
    insert (size_t pos1, const basic_wstring<charT>& str, size_t pos2 = 0,
    ...
    basic_wstring<charT>&
    replace (size_t pos1, size_t n1, const basic_wstring<charT>& str, size_t pos2 = 0,
    ...
    size_t
    find (const basic_wstring<charT>& str, size_t pos = 0) const _THROW_NONE ;
    ...
    size_t
    rfind (const basic_wstring<charT>& str, size_t pos = NPOS) const _THROW_NONE ;
    ...
    size_t
    find_first_of (const basic_wstring<charT>& str, size_t pos = 0) const _THROW_NONE ;
    ...
    size_t
    find_last_of (const basic_wstring<charT>& str, size_t pos = NPOS) const
                  _THROW_NONE ;
    ...
    size_t
    find_first_not_of (const basic_wstring<charT>& str, size_t pos = 0) const
                       _THROW_NONE ;
    ...
    size_t
    find_last_not_of (const basic_wstring<charT>& str, size_t pos = NPOS) const
                      _THROW_NONE ;
    ...
    int
    compare (const basic_wstring<charT>& str, size_t pos = 0, size_t n = NPOS) const
             _THROW_OUTRANGE ;
    ...
    friend
    ostream&
    operator<< (ostream& o, const basic_wstring<charT>& s) _THROW_NONE ;

    friend
    istream&
    operator>> (istream& i, basic_wstring<charT>& s) _THROW_ALLOC_LENGTH ;

    friend
    basic_wstring<charT>
    operator+ (const basic_wstring<charT>& lhs, const basic_wstring<charT>& rhs)
    _THROW_ALLOC_LENGTH ;

    friend
    basic_wstring<charT>
    operator+ (const charT* lhs, const basic_wstring<charT>& rhs)
    _THROW_ALLOC_LENGTH ;

    friend
    basic_wstring<charT>
    operator+ (charT lhs, const basic_wstring<charT>& rhs) _THROW_ALLOC_LENGTH ;

    friend
    basic_wstring<charT>
    operator+ (const basic_wstring<charT>& lhs, const charT* rhs)
    _THROW_ALLOC_LENGTH ;

    friend
    basic_wstring<charT>
    operator+ (const basic_wstring<charT>& lhs, charT rhs) _THROW_ALLOC_LENGTH ;
...
{
#ifdef  __MEXCEPT
   throw   length_error(L"Length exception occurred");
#else
   cout << L"Length exception occurred" << endl;
   exit(1);
#endif
}
...
{
#ifdef  __MEXCEPT
   throw   out_of_range(L"Out of range exception occurred");
#else
   cout << L"Out of range exception occurred" << endl;
   exit(1);
#endif
}
...
template <class charT>
inline void
basic_wstring<charT>::delete_ref () _THROW_NONE
{
    --(reference->count);
    if (!(reference->count))
       delete reference;
...
template <class charT>
inline size_t
basic_wstring<charT>::ref_count () const _THROW_NONE
{
...
template <class charT>
inline const charT*
basic_wstring<charT>::data () const _THROW_NONE
{
    if (length())
...
template <class charT>
inline charT*
basic_wstring<charT>::point () _THROW_NONE
{
    return reference->ptr;
}
...
template <class charT>
inline size_t&
basic_wstring<charT>::len () _THROW_NONE
{
...
template <class charT>
inline size_t
basic_wstring<charT>::length () const _THROW_NONE
{
    return reference->len;
}
...
template <class charT>
inline size_t
basic_wstring<charT>::reserve () const _THROW_NONE
{
...
template <class charT>
inline charT
basic_wstring<charT>::get_at (size_t pos) const _THROW_OUTRANGE
{
    if (pos >= length())
    {
...
template <class charT>
inline charT
basic_wstring<charT>::operator[] (size_t pos) const _THROW_NONE
{
    if (pos < length())
        return *(data()+pos);
    else
...
template <class charT>
inline bool
operator== (const charT* lhs, const basic_wstring<charT>& rhs) _THROW_NONE
{
...
template <class charT>
inline bool
operator== (charT lhs, const basic_wstring<charT>& rhs) _THROW_NONE
{
    return !(rhs.compare(lhs));
}
...
template <class charT>
inline bool
operator== (const basic_wstring<charT>& lhs, const charT* rhs) _THROW_NONE
{
    return !(lhs.compare(rhs));
}
...
template <class charT>
inline bool
operator== (const basic_wstring<charT>& lhs, charT rhs) _THROW_NONE
{
    return !(lhs.compare(rhs));
}
...
template <class charT>
basic_string_ref<charT>::basic_string_ref (const basic_wstring<charT>& str,
...
template <class charT>
charT
basic_wstring<charT>::eos () _THROW_NONE
{
    return baggage_type::eos();
}
...
template <class charT>
void
basic_wstring<charT>::assign_str (const charT* s, size_t slen)
                                 _THROW_ALLOC_LENGTH
{
    if (slen == NPOS)
    {
...
template <class charT>
void
basic_wstring<charT>::append_str (const charT* s, size_t slen)
                                 _THROW_ALLOC_LENGTH
{
    if (length() >= (NPOS-slen))
    {
...
template <class charT>
void
basic_wstring<charT>::insert_str (size_t pos, const charT* s, size_t slen)
                                 _THROW_ALLOC_LENGTH_OUTRANGE
{
    if (pos > length())
    {
...
template <class charT>
void
basic_wstring<charT>::replace_str (size_t xlen, size_t pos, const charT* s,
...
template <class charT>
int
basic_wstring<charT>::compare_str (size_t pos, const charT* str, size_t slen,
...
template <class charT>
size_t
basic_wstring<charT>::find_str (const charT* s, size_t pos, size_t len) 
                               const _THROW_NONE
{
    size_t  count = pos;
    size_t  shift;
...
template <class charT>
size_t
basic_wstring<charT>::rfind_str (const charT* s, size_t pos, size_t len) 
                                const _THROW_NONE
{
    size_t  count = 1+ (pos < (length()-len)) ? pos : (length()-len);
    size_t  shift;
    size_t  place;    
    if ((length() < len) || (len == 0))
        return NPOS;
...
template <class charT>
size_t
basic_wstring<charT>::find_first_of_str (const charT* s, size_t pos, size_t len) 
                                        const _THROW_NONE
{
    size_t temp;
    size_t count  = pos;
...
template <class charT>
size_t
basic_wstring<charT>::find_last_of_str (const charT* s, size_t pos, size_t len) 
                                       const _THROW_NONE
{
    size_t temp = 0;
...
template <class charT>
size_t
basic_wstring<charT>::find_first_not_of_str (const charT* s, size_t pos,
...
template <class charT>
size_t
basic_wstring<charT>::find_last_not_of_str (const charT* s, size_t pos,
                     size_t len) const _THROW_NONE
{
    size_t temp = 0;
    size_t count = (pos < length()) ? (pos+1) : length();
...
template <class charT>
basic_wstring<charT>::basic_wstring () _THROW_ALLOC
{
...
template <class charT>
basic_wstring<charT>::basic_wstring (size_t size, capacity cap)
                                   _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>::basic_wstring (const basic_wstring<charT>& str,
...
template <class charT>
basic_wstring<charT>::basic_wstring (const charT* s, size_t rlen, size_t xlen)
                                   _THROW_ALLOC_LENGTH
{
    if (rlen >= (NPOS - xlen))
    {
...
template <class charT>
basic_wstring<charT>::basic_wstring (const charT* s, size_t n) _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>::basic_wstring (const charT* s) _THROW_ALLOC
{
...
template <class charT>
basic_wstring<charT>::basic_wstring (charT c, size_t rep) _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>::basic_wstring (const vector<charT>& vec) _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>::~basic_wstring () _THROW_NONE
{
    delete_ref();
    if (c_str_ptr)
        delete[] c_str_ptr;
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator= (const basic_wstring<charT>& str) _THROW_ALLOC
{
    if (this != &str)
    {
        delete_ref();
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator= (const charT* s) _THROW_ALLOC
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator= (charT c) _THROW_ALLOC
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator+= (const basic_wstring<charT>& rhs) _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator+= (const charT* s) _THROW_ALLOC_LENGTH
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::operator+= (charT c) _THROW_ALLOC_LENGTH
{
    if (length() >= (NPOS-1))
    {
        reference_class::throwlength();
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::append (const basic_wstring<charT>& str, size_t pos, size_t n)
                     _THROW_ALLOC_LENGTH_OUTRANGE
{
    if (pos > str.length())
    {
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::append (const charT* s, size_t n) _THROW_ALLOC_LENGTH
{
    append_str (s, n);
    return *this;
}
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::append (const charT* s) _THROW_ALLOC_LENGTH
{
    append_str (s, baggage_type::length(s));
    return *this;
}
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::append (charT c, size_t rep) _THROW_ALLOC_LENGTH
{
    if (length() >= (NPOS-rep))
    {
        reference_class::throwlength();
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::assign (const basic_wstring<charT>& str, size_t pos, size_t n)
                             _THROW_ALLOC_LENGTH_OUTRANGE
{
    if (pos > str.length())
    {
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::assign (const charT* s, size_t n) _THROW_ALLOC_LENGTH
{
    assign_str (s, n);
    return *this;
}
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::assign (const charT* s) _THROW_ALLOC_LENGTH
{
    assign_str (s, baggage_type::length(s));
    return *this;
}
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::assign (charT c, size_t rep) _THROW_ALLOC_LENGTH
{
    if (rep == NPOS)
    {
        reference_class::throwlength();
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::insert (size_t pos1, const basic_wstring<charT>& str,
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::insert (size_t pos, const charT* s, size_t n)
                             _THROW_ALLOC_LENGTH_OUTRANGE
{
    insert_str(pos, s, n);
    return *this;
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::insert (size_t pos, const charT* s)
                             _THROW_ALLOC_LENGTH_OUTRANGE
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::insert (size_t pos, charT c, size_t rep)
                             _THROW_ALLOC_LENGTH_OUTRANGE
{
    if (pos > length())
    {
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::remove (size_t pos, size_t n) _THROW_ALLOC_OUTRANGE
{
    if (pos > length())
    {
        reference_class::throwrange();
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::replace (size_t pos1, size_t n1, const basic_wstring<charT>& str,
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::replace (size_t pos, size_t n1, const charT* s, size_t n2)
                              _THROW_ALLOC_LENGTH_OUTRANGE
{
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::replace (size_t pos, size_t n1, const charT* s)
                              _THROW_ALLOC_LENGTH_OUTRANGE
{
    size_t xlen = (n1 > (length()-pos)) ? (length()-pos) : n1;
...
template <class charT>
basic_wstring<charT>&
basic_wstring<charT>::replace (size_t pos, size_t n, charT c, size_t rep)
                              _THROW_ALLOC_LENGTH_OUTRANGE
{
    if (pos > length())
    {
...
template <class charT>
void
basic_wstring<charT>::put_at (size_t pos, charT c) _THROW_ALLOC_OUTRANGE
{
    if (pos > length())
    {
        reference_class::throwrange();
...
template <class charT>
charT&
basic_wstring<charT>::operator[] (size_t pos) _THROW_ALLOC_OUTRANGE
{
    if (pos >= length())
    {
        reference_class::throwrange();
...
template <class charT>
const charT*
basic_wstring<charT>::c_str () const _THROW_ALLOC
{
    if (c_str_ptr)
        delete[] ((basic_wstring<charT>*)this)->c_str_ptr;
    ((basic_wstring<charT>*)this)->c_str_ptr = new charT [length()+1];
    if (length())
        baggage_type::copy (((basic_wstring<charT>*)this)->c_str_ptr, data(),
                              length());
    baggage_type::assign (*(((basic_wstring<charT>*)this)->c_str_ptr+length()),
                          eos());
    return c_str_ptr;
}
...
template <class charT>
void
basic_wstring<charT>::resize (size_t n, charT c) _THROW_ALLOC_LENGTH
{
    if (n == NPOS)
    {
        reference_class::throwlength();
...
template <class charT>
void
basic_wstring<charT>::resize (size_t n) _THROW_ALLOC_LENGTH
{
    resize (n, eos());
}
...
template <class charT>
void
basic_wstring<charT>::reserve (size_t res_arg) _THROW_ALLOC_LENGTH
{
    if (res_arg == NPOS)
    {
        reference_class::throwlength();
...
template <class charT>
size_t
basic_wstring<charT>::copy (charT* s, size_t n, size_t pos) const _THROW_OUTRANGE
{
    if (pos > length())
    {
        reference_class::throwrange();
...
template <class charT>
size_t
basic_wstring<charT>::find (const basic_wstring<charT>& str, size_t pos) const
                           _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find (const charT* s, size_t pos, size_t n) const
                           _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find (const charT* s, size_t pos) const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find (charT c, size_t pos) const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::rfind (const basic_wstring<charT>& str, size_t pos) const
                            _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::rfind (const charT* s, size_t pos, size_t n) const
                            _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::rfind (const charT* s, size_t pos) const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::rfind (charT c, size_t pos) const _THROW_NONE
{
    size_t count = ((pos < length()) ? pos+1 : length());
    if (length() == 0)
        return NPOS;
...
template <class charT>
size_t
basic_wstring<charT>::find_first_of (const basic_wstring<charT>& str, size_t pos) const
                                    _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_of (const charT* s, size_t pos, size_t n) const
                                    _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_of (const charT* s, size_t pos) const
                                    _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_of (charT c, size_t pos) const _THROW_NONE
{
    return find (c, pos);
}
...
template <class charT>
size_t
basic_wstring<charT>::find_last_of (const basic_wstring<charT>& str, size_t pos) const
                                   _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_of (const charT* s, size_t pos, size_t n) const
                                   _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_of (const charT* s, size_t pos) const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_of (charT c, size_t pos) const _THROW_NONE
{
    return rfind (c, pos);
}
...
template <class charT>
size_t
basic_wstring<charT>::find_first_not_of (const basic_wstring<charT>& str, size_t pos)
                                        const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_not_of (const charT* s, size_t pos, size_t n)
                                        const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_not_of (const charT* s, size_t pos) const
                                        _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_first_not_of (charT c, size_t pos) const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_not_of (const basic_wstring<charT>& str, size_t pos)
                                       const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_not_of (const charT* s, size_t pos, size_t n)
                                       const _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_not_of (const charT* s, size_t pos) const
                                       _THROW_NONE
{
...
template <class charT>
size_t
basic_wstring<charT>::find_last_not_of (charT c, size_t pos) const _THROW_NONE
{
    size_t count = ((pos < length()) ? pos+1 : length());
    if (length() == 0)
        return NPOS;
...
template <class charT>
basic_wstring<charT>
basic_wstring<charT>::substr (size_t pos,  size_t n) const _THROW_ALLOC_OUTRANGE
{
    if (pos > length())
    {
        reference_class::throwrange();
    ...
    if (length())
        return basic_wstring<charT> (data()+pos,
        (n > (length()-pos)) ? (length()-pos) : n);
    else
        return basic_wstring<charT>();
}

template <class charT>
int
basic_wstring<charT>::compare (const basic_wstring<charT>& str, size_t pos,
...
template <class charT>
int
basic_wstring<charT>::compare (const charT* s, size_t pos, size_t n) const
                              _THROW_LENGTH_OUTRANGE
{
    if (n == NPOS)
    {
...
template <class charT>
int
basic_wstring<charT>::compare (const charT* s, size_t pos) const _THROW_OUTRANGE
{
...
template <class charT>
int
basic_wstring<charT>::compare (charT c, size_t pos, size_t rep) const
                              _THROW_LENGTH_OUTRANGE
{
    if (pos > length())
    {
...
operator+ (const basic_wstring<charT>& lhs, const basic_wstring<charT>& rhs)
           _THROW_ALLOC_LENGTH
{
    typedef  basic_wstring<charT>::baggage_type  baggage_type;
    basic_wstring<charT> tmp(lhs.data(), lhs.length(), rhs.length());
    if (rhs.length())
...
template <class charT>
basic_wstring<charT>
operator+ (const charT* lhs, const basic_wstring<charT>& rhs) _THROW_ALLOC_LENGTH
{
    typedef  basic_wstring<charT>::baggage_type  baggage_type; 
    size_t  slen = baggage_type::length(lhs);
    basic_wstring<charT> tmp(lhs, slen, rhs.length());
    if (rhs.length())
...
{
    typedef  basic_wstring<charT>::baggage_type  baggage_type; 
    basic_wstring<charT> tmp(&lhs, 1, rhs.length());
    if (rhs.length())
...
template <class charT>
basic_wstring<charT>
operator+ (const basic_wstring<charT>& lhs, const charT* rhs) _THROW_ALLOC_LENGTH
{
    typedef  basic_wstring<charT>::baggage_type  baggage_type; 
    size_t  slen = baggage_type::length(rhs);
    basic_wstring<charT> tmp(lhs.data(), lhs.length(), slen);
    if (slen)
...
{
    typedef  basic_wstring<charT>::baggage_type  baggage_type; 
    basic_wstring<charT> tmp(lhs.data(), lhs.length(), 1);
...
typedef  basic_wstring<wchar_t>     cwstring;
typedef  basic_wstring<wchar_t>     wstring;
// typedef  basic_wstring<wchar_t>  wwstring;
...
inline void destroy(wstring* pointer) {
    pointer->~basic_wstring();
}
