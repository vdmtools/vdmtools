...
#if !DEF_type_FFb3P && DECL_type_FFb3P
#define DEF_type_FFb3P 1

void type_FFb3P::Init(Generic p1, TYPE_AS_Bind p2, Bool p3) {
  SetField(1, p1);
  SetField(2, p2);
  SetField(3, p3);
}

Generic type_FFb3P::get_1() const { return (Generic) GetField(1); }

void type_FFb3P::set_1(const Generic &p) { SetField(1, p); }

TYPE_AS_Bind type_FFb3P::get_2() const { return (TYPE_AS_Bind) GetField(2); }

void type_FFb3P::set_2(const TYPE_AS_Bind &p) { SetField(2, p); }

Bool type_FFb3P::get_3() const { return (Bool) GetField(3); }

void type_FFb3P::set_3(const Bool &p) { SetField(3, p); }
#endif

#if !DEF_type_FFL2P && DECL_type_FFL2P
#define DEF_type_FFL2P 1

void type_FFL2P::Init(Generic p1, TYPE_AS_BindList p2) {
  SetField(1, p1);
  SetField(2, p2);
}

Generic type_FFL2P::get_1() const { return (Generic) GetField(1); }

void type_FFL2P::set_1(const Generic &p) { SetField(1, p); }

TYPE_AS_BindList type_FFL2P::get_2() const { return (TYPE_AS_BindList) GetField(2); }

void type_FFL2P::set_2(const TYPE_AS_BindList &p) { SetField(2, p); }
#endif

#if !DEF_type_Fd2P && DECL_type_Fd2P
#define DEF_type_Fd2P 1

void type_Fd2P::Init(TYPE_TRF_uTAR_uPAT_PatternBind p1, TYPE_TRF_uTAR_uEXPR_Expr p2) {
  SetField(1, p1);
  SetField(2, p2);
}

TYPE_TRF_uTAR_uPAT_PatternBind type_Fd2P::get_1() const { return (TYPE_TRF_uTAR_uPAT_PatternBind) GetField(1); }

void type_Fd2P::set_1(const TYPE_TRF_uTAR_uPAT_PatternBind &p) { SetField(1, p); }

TYPE_TRF_uTAR_uEXPR_Expr type_Fd2P::get_2() const { return (TYPE_TRF_uTAR_uEXPR_Expr) GetField(2); }

void type_Fd2P::set_2(const TYPE_TRF_uTAR_uEXPR_Expr &p) { SetField(2, p); }
#endif

#if !DEF_type_FF2P && DECL_type_FF2P
#define DEF_type_FF2P 1

void type_FF2P::Init(TYPE_AS_Expr p1, TYPE_AS_MultBind p2) {
  SetField(1, p1);
  SetField(2, p2);
}

TYPE_AS_Expr type_FF2P::get_1() const { return (TYPE_AS_Expr) GetField(1); }

void type_FF2P::set_1(const TYPE_AS_Expr &p) { SetField(1, p); }

TYPE_AS_MultBind type_FF2P::get_2() const { return (TYPE_AS_MultBind) GetField(2); }

void type_FF2P::set_2(const TYPE_AS_MultBind &p) { SetField(2, p); }
#endif

#if !DEF_type_FLFL2P && DECL_type_FLFL2P
#define DEF_type_FLFL2P 1

void type_FLFL2P::Init(type_FL p1, TYPE_AS_BindList p2) {
  SetField(1, p1);
  SetField(2, p2);
}

type_FL type_FLFL2P::get_1() const { return (type_FL) GetField(1); }

void type_FLFL2P::set_1(const type_FL &p) { SetField(1, p); }

TYPE_AS_BindList type_FLFL2P::get_2() const { return (TYPE_AS_BindList) GetField(2); }

void type_FLFL2P::set_2(const TYPE_AS_BindList &p) { SetField(2, p); }
#endif
