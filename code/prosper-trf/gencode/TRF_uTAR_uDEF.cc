              ...
              if (((Record) vdm_TRF_uTAR_uDEF_head).Is(vdm_TRF_uTAR_uPAT_RecordPattern)) 
                ...
                if (((Record) vdm_TRF_uTAR_uDEF_head).Is(vdm_TRF_uTAR_uPAT_PatternName)) 
                  ...
                  if (((Record) vdm_TRF_uTAR_uDEF_head).Is(vdm_TRF_uTAR_uPAT_MatchVal)) 
                    ...
                    RunTime("Unknown record field selector");    bool succ_15 = true;    {
                  ...
                  if (((Record) vdm_TRF_uTAR_uDEF_simp_uhead).Is(vdm_TRF_uTAR_uPAT_RecordPattern)) 
                    ...
                    if (((Record) vdm_TRF_uTAR_uDEF_simp_uhead).Is(vdm_TRF_uTAR_uPAT_PatternName)) 
                      ...
                      if (((Record) vdm_TRF_uTAR_uDEF_simp_uhead).Is(vdm_TRF_uTAR_uPAT_MatchVal)) 
                        ...
                        RunTime("Unknown record field selector");
        vdm_TRF_uTAR_uDEF_val = vdm_TRF_uCAST_PatternName2Expr((Generic) par_42);
...
TYPE_TRF_uTAR_uDEF_ExplFnDef vdm_TRF_uTAR_uDEF_tar_uExplFunction(const TYPE_TRF_uTAR_uEXPR_NameName &vdm_TRF_uTAR_uDEF_nm, const TYPE_TRF_uTAR_uDEF_TypeVarList &vdm_TRF_uTAR_uDEF_tpvarlst, const TYPE_TRF_uTAR_uTYPE_FnType &vdm_TRF_uTAR_uDEF_tp, const TYPE_TRF_uTAR_uDEF_ParametersList &vdm_TRF_uTAR_uDEF_parmlst, const TYPE_TRF_uTAR_uDEF_FnBody &vdm_TRF_uTAR_uDEF_fnbody, const Generic &vdm_TRF_uTAR_uDEF_fnpre, const Generic &vdm_TRF_uTAR_uDEF_fnpost, const TYPE_CI_ContextId &vdm_TRF_uTAR_uDEF_cid) {
  Record varRes_10(vdm_AS_ExplFnDef, length_AS_ExplFnDef);
  {
    ...
    if (cond_105.GetValue()) {
      ...
      Int tmpVar_126;
      if (vdm_TRF_uTAR_uDEF_fnbody.Is(vdm_TRF_uTAR_uDEF_FnBody)) 
        tmpVar_126 = vdm_TRF_uTAR_uDEF_fnbody.GetField(pos_TRF_uTAR_uDEF_FnBody_cid);
      else 
        RunTime("Unknown record field selector");
      vdm_TRF_uTAR_uDEF_as_ufnbody.SetField(2, tmpVar_126);
    }
    else {
      Generic vdm_TRF_uTAR_uDEF_body;
      if (((Bool) (vdm_TRF_uTAR_uDEF_ldefs == Sequence())).GetValue()) 
        if (vdm_TRF_uTAR_uDEF_fnbody.Is(vdm_TRF_uTAR_uDEF_FnBody)) 
          vdm_TRF_uTAR_uDEF_body = vdm_TRF_uTAR_uDEF_fnbody.GetField(pos_TRF_uTAR_uDEF_FnBody_body);
        else 
          RunTime("Unknown record field selector");
      else {
        Generic par_116;
        if (vdm_TRF_uTAR_uDEF_fnbody.Is(vdm_TRF_uTAR_uDEF_FnBody)) 
          par_116 = vdm_TRF_uTAR_uDEF_fnbody.GetField(pos_TRF_uTAR_uDEF_FnBody_body);
        else 
          RunTime("Unknown record field selector");
        Int par_118;
        if (vdm_TRF_uTAR_uDEF_fnbody.Is(vdm_TRF_uTAR_uDEF_FnBody)) 
          par_118 = vdm_TRF_uTAR_uDEF_fnbody.GetField(pos_TRF_uTAR_uDEF_FnBody_cid);
        else 
          RunTime("Unknown record field selector");
        vdm_TRF_uTAR_uDEF_body = vdm_TRF_uTAR_uEXPR_tar_uLetExpr((Generic) vdm_TRF_uTAR_uDEF_ldefs, (Generic) par_116, (Generic) par_118);
      }
      vdm_TRF_uTAR_uDEF_as_ufnbody = Record(vdm_AS_FnBody, length_AS_FnBody);
      Record tmpVar_121;
      if (vdm_TRF_uTAR_uDEF_body.IsRecord()) 
        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_UndefinedExpr)) 
          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_UndefinedExpr_expr);
        else 
          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_TypeJudgementExpr)) 
            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_TypeJudgementExpr_expr);
          else 
            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_TupleSelectExpr)) 
              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_TupleSelectExpr_expr);
            else 
              if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_TupleConstructorExpr)) 
                tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_TupleConstructorExpr_expr);
              else 
                if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_TokenConstructorExpr)) 
                  tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_TokenConstructorExpr_expr);
                else 
                  if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_TextLit)) 
                    tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_TextLit_expr);
                  else 
                    if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SubSequenceExpr)) 
                      tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SubSequenceExpr_expr);
                    else 
                      if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SetRangeExpr)) 
                        tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SetRangeExpr_expr);
                      else 
                        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SetEnumerationExpr)) 
                          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SetEnumerationExpr_expr);
                        else 
                          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SetComprehensionExpr)) 
                            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SetComprehensionExpr_expr);
                          else 
                            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr)) 
                              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr_expr);
                            else 
                              if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SeqEnumerationExpr)) 
                                tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SeqEnumerationExpr_expr);
                              else 
                                if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_SeqComprehensionExpr)) 
                                  tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_SeqComprehensionExpr_expr);
                                else 
                                  if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_RecordModifierExpr)) 
                                    tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_RecordModifierExpr_expr);
                                  else 
                                    if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_RecordConstructorExpr)) 
                                      tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_RecordConstructorExpr_expr);
                                    else 
                                      if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_RealLit)) 
                                        tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_RealLit_expr);
                                      else 
                                        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_QuoteLit)) 
                                          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_QuoteLit_expr);
                                        else 
                                          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_PrefixExpr)) 
                                            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_PrefixExpr_expr);
                                          else 
                                            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_PreConditionApplyExpr)) 
                                              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_PreConditionApplyExpr_expr);
                                            else 
                                              if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_OldName)) 
                                                tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_OldName_expr);
                                              else 
                                                if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_NumLit)) 
                                                  tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_NumLit_expr);
                                                else 
                                                  if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_NilLit)) 
                                                    tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_NilLit_expr);
                                                  else 
                                                    if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_NameExpr)) 
                                                      tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_NameExpr_expr);
                                                    else 
                                                      if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_MapInverseExpr)) 
                                                        tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_MapInverseExpr_expr);
                                                      else 
                                                        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_MapEnumerationExpr)) 
                                                          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_MapEnumerationExpr_expr);
                                                        else 
                                                          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_MapComprehensionExpr)) 
                                                            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_MapComprehensionExpr_expr);
                                                          else 
                                                            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_LetExpr)) 
                                                              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_LetExpr_expr);
                                                            else 
                                                              if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_LetBeSTExpr)) 
                                                                tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_LetBeSTExpr_expr);
                                                              else 
                                                                if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_LambdaExpr)) 
                                                                  tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_LambdaExpr_expr);
                                                                else 
                                                                  if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_IsExpr)) 
                                                                    tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_IsExpr_expr);
                                                                  else 
                                                                    if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_IotaExpr)) 
                                                                      tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_IotaExpr_expr);
                                                                    else 
                                                                      if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_IfExpr)) 
                                                                        tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_IfExpr_expr);
                                                                      else 
                                                                        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_FieldSelectExpr)) 
                                                                          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_FieldSelectExpr_expr);
                                                                        else 
                                                                          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_FctTypeInstExpr)) 
                                                                            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_FctTypeInstExpr_expr);
                                                                          else 
                                                                            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_ExistsUniqueExpr)) 
                                                                              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_ExistsUniqueExpr_expr);
                                                                            else 
                                                                              if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_DefExpr)) 
                                                                                tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_DefExpr_expr);
                                                                              else 
                                                                                if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_CharLit)) 
                                                                                  tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_CharLit_expr);
                                                                                else 
                                                                                  if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_CasesExpr)) 
                                                                                    tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_CasesExpr_expr);
                                                                                  else 
                                                                                    if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_BracketedExpr)) 
                                                                                      tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_BracketedExpr_expr);
                                                                                    else 
                                                                                      if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_BoolLit)) 
                                                                                        tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_BoolLit_expr);
                                                                                      else 
                                                                                        if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_BinaryExpr)) 
                                                                                          tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_BinaryExpr_expr);
                                                                                        else 
                                                                                          if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_ApplyExpr)) 
                                                                                            tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_ApplyExpr_expr);
                                                                                          else 
                                                                                            if (((Record) vdm_TRF_uTAR_uDEF_body).Is(vdm_TRF_uTAR_uEXPR_AllOrExistsExpr)) 
                                                                                              tmpVar_121 = ((Record) vdm_TRF_uTAR_uDEF_body).GetField(pos_TRF_uTAR_uEXPR_AllOrExistsExpr_expr);
                                                                                            else 
                                                                                              RunTime("Unknown record field selector");
      else 
        RunTime("A record was expected");
      vdm_TRF_uTAR_uDEF_as_ufnbody.SetField(1, tmpVar_121);
      Int tmpVar_123;
      if (vdm_TRF_uTAR_uDEF_fnbody.Is(vdm_TRF_uTAR_uDEF_FnBody)) 
        tmpVar_123 = vdm_TRF_uTAR_uDEF_fnbody.GetField(pos_TRF_uTAR_uDEF_FnBody_cid);
      else 
        RunTime("Unknown record field selector");
      vdm_TRF_uTAR_uDEF_as_ufnbody.SetField(2, tmpVar_123);
    }
    ...
    if (((Bool) (vdm_TRF_uTAR_uDEF_fnpre == Nil())).GetValue()) 
      ...
      if (((Bool) (vdm_TRF_uTAR_uDEF_ldefs == Sequence())).GetValue()) 
        if (vdm_TRF_uTAR_uDEF_fnpre.IsRecord()) 
          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_UndefinedExpr)) 
            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_UndefinedExpr_expr);
          else 
            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_TypeJudgementExpr)) 
              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_TypeJudgementExpr_expr);
            else 
              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_TupleSelectExpr)) 
                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_TupleSelectExpr_expr);
              else 
                if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_TupleConstructorExpr)) 
                  vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_TupleConstructorExpr_expr);
                else 
                  if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_TokenConstructorExpr)) 
                    vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_TokenConstructorExpr_expr);
                  else 
                    if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_TextLit)) 
                      vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_TextLit_expr);
                    else 
                      if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SubSequenceExpr)) 
                        vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SubSequenceExpr_expr);
                      else 
                        if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SetRangeExpr)) 
                          vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SetRangeExpr_expr);
                        else 
                          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SetEnumerationExpr)) 
                            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SetEnumerationExpr_expr);
                          else 
                            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SetComprehensionExpr)) 
                              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SetComprehensionExpr_expr);
                            else 
                              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr)) 
                                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr_expr);
                              else 
                                if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SeqEnumerationExpr)) 
                                  vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SeqEnumerationExpr_expr);
                                else 
                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_SeqComprehensionExpr)) 
                                    vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_SeqComprehensionExpr_expr);
                                  else 
                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_RecordModifierExpr)) 
                                      vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_RecordModifierExpr_expr);
                                    else 
                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_RecordConstructorExpr)) 
                                        vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_RecordConstructorExpr_expr);
                                      else 
                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_RealLit)) 
                                          vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_RealLit_expr);
                                        else 
                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_QuoteLit)) 
                                            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_QuoteLit_expr);
                                          else 
                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_PrefixExpr)) 
                                              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_PrefixExpr_expr);
                                            else 
                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_PreConditionApplyExpr)) 
                                                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_PreConditionApplyExpr_expr);
                                              else 
                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_OldName)) 
                                                  vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_OldName_expr);
                                                else 
                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_NumLit)) 
                                                    vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_NumLit_expr);
                                                  else 
                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_NilLit)) 
                                                      vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_NilLit_expr);
                                                    else 
                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_NameExpr)) 
                                                        vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_NameExpr_expr);
                                                      else 
                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_MapInverseExpr)) 
                                                          vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_MapInverseExpr_expr);
                                                        else 
                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_MapEnumerationExpr)) 
                                                            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_MapEnumerationExpr_expr);
                                                          else 
                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_MapComprehensionExpr)) 
                                                              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_MapComprehensionExpr_expr);
                                                            else 
                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_LetExpr)) 
                                                                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_LetExpr_expr);
                                                              else 
                                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_LetBeSTExpr)) 
                                                                  vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_LetBeSTExpr_expr);
                                                                else 
                                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_LambdaExpr)) 
                                                                    vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_LambdaExpr_expr);
                                                                  else 
                                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_IsExpr)) 
                                                                      vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_IsExpr_expr);
                                                                    else 
                                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_IotaExpr)) 
                                                                        vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_IotaExpr_expr);
                                                                      else 
                                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_IfExpr)) 
                                                                          vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_IfExpr_expr);
                                                                        else 
                                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_FieldSelectExpr)) 
                                                                            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_FieldSelectExpr_expr);
                                                                          else 
                                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_FctTypeInstExpr)) 
                                                                              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_FctTypeInstExpr_expr);
                                                                            else 
                                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_ExistsUniqueExpr)) 
                                                                                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_ExistsUniqueExpr_expr);
                                                                              else 
                                                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_DefExpr)) 
                                                                                  vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_DefExpr_expr);
                                                                                else 
                                                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_CharLit)) 
                                                                                    vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_CharLit_expr);
                                                                                  else 
                                                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_CasesExpr)) 
                                                                                      vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_CasesExpr_expr);
                                                                                    else 
                                                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_BracketedExpr)) 
                                                                                        vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_BracketedExpr_expr);
                                                                                      else 
                                                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_BoolLit)) 
                                                                                          vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_BoolLit_expr);
                                                                                        else 
                                                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_BinaryExpr)) 
                                                                                            vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_BinaryExpr_expr);
                                                                                          else 
                                                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_ApplyExpr)) 
                                                                                              vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_ApplyExpr_expr);
                                                                                            else 
                                                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpre).Is(vdm_TRF_uTAR_uEXPR_AllOrExistsExpr)) 
                                                                                                vdm_TRF_uTAR_uDEF_as_ufnpre = ((Record) vdm_TRF_uTAR_uDEF_fnpre).GetField(pos_TRF_uTAR_uEXPR_AllOrExistsExpr_expr);
                                                                                              else 
                                                                                                RunTime("Unknown record field selector");
        else 
          RunTime("A record was expected");
    ...
    if (((Bool) (vdm_TRF_uTAR_uDEF_fnpost == Nil())).GetValue()) 
      ...
      if (((Bool) (vdm_TRF_uTAR_uDEF_ldefs == Sequence())).GetValue()) 
        if (vdm_TRF_uTAR_uDEF_fnpost.IsRecord()) 
          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_UndefinedExpr)) 
            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_UndefinedExpr_expr);
          else 
            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_TypeJudgementExpr)) 
              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_TypeJudgementExpr_expr);
            else 
              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_TupleSelectExpr)) 
                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_TupleSelectExpr_expr);
              else 
                if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_TupleConstructorExpr)) 
                  vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_TupleConstructorExpr_expr);
                else 
                  if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_TokenConstructorExpr)) 
                    vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_TokenConstructorExpr_expr);
                  else 
                    if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_TextLit)) 
                      vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_TextLit_expr);
                    else 
                      if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SubSequenceExpr)) 
                        vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SubSequenceExpr_expr);
                      else 
                        if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SetRangeExpr)) 
                          vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SetRangeExpr_expr);
                        else 
                          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SetEnumerationExpr)) 
                            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SetEnumerationExpr_expr);
                          else 
                            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SetComprehensionExpr)) 
                              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SetComprehensionExpr_expr);
                            else 
                              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr)) 
                                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SeqModifyMapOverrideExpr_expr);
                              else 
                                if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SeqEnumerationExpr)) 
                                  vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SeqEnumerationExpr_expr);
                                else 
                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_SeqComprehensionExpr)) 
                                    vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_SeqComprehensionExpr_expr);
                                  else 
                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_RecordModifierExpr)) 
                                      vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_RecordModifierExpr_expr);
                                    else 
                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_RecordConstructorExpr)) 
                                        vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_RecordConstructorExpr_expr);
                                      else 
                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_RealLit)) 
                                          vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_RealLit_expr);
                                        else 
                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_QuoteLit)) 
                                            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_QuoteLit_expr);
                                          else 
                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_PrefixExpr)) 
                                              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_PrefixExpr_expr);
                                            else 
                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_PreConditionApplyExpr)) 
                                                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_PreConditionApplyExpr_expr);
                                              else 
                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_OldName)) 
                                                  vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_OldName_expr);
                                                else 
                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_NumLit)) 
                                                    vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_NumLit_expr);
                                                  else 
                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_NilLit)) 
                                                      vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_NilLit_expr);
                                                    else 
                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_NameExpr)) 
                                                        vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_NameExpr_expr);
                                                      else 
                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_MapInverseExpr)) 
                                                          vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_MapInverseExpr_expr);
                                                        else 
                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_MapEnumerationExpr)) 
                                                            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_MapEnumerationExpr_expr);
                                                          else 
                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_MapComprehensionExpr)) 
                                                              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_MapComprehensionExpr_expr);
                                                            else 
                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_LetExpr)) 
                                                                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_LetExpr_expr);
                                                              else 
                                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_LetBeSTExpr)) 
                                                                  vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_LetBeSTExpr_expr);
                                                                else 
                                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_LambdaExpr)) 
                                                                    vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_LambdaExpr_expr);
                                                                  else 
                                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_IsExpr)) 
                                                                      vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_IsExpr_expr);
                                                                    else 
                                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_IotaExpr)) 
                                                                        vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_IotaExpr_expr);
                                                                      else 
                                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_IfExpr)) 
                                                                          vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_IfExpr_expr);
                                                                        else 
                                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_FieldSelectExpr)) 
                                                                            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_FieldSelectExpr_expr);
                                                                          else 
                                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_FctTypeInstExpr)) 
                                                                              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_FctTypeInstExpr_expr);
                                                                            else 
                                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_ExistsUniqueExpr)) 
                                                                                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_ExistsUniqueExpr_expr);
                                                                              else 
                                                                                if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_DefExpr)) 
                                                                                  vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_DefExpr_expr);
                                                                                else 
                                                                                  if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_CharLit)) 
                                                                                    vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_CharLit_expr);
                                                                                  else 
                                                                                    if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_CasesExpr)) 
                                                                                      vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_CasesExpr_expr);
                                                                                    else 
                                                                                      if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_BracketedExpr)) 
                                                                                        vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_BracketedExpr_expr);
                                                                                      else 
                                                                                        if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_BoolLit)) 
                                                                                          vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_BoolLit_expr);
                                                                                        else 
                                                                                          if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_BinaryExpr)) 
                                                                                            vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_BinaryExpr_expr);
                                                                                          else 
                                                                                            if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_ApplyExpr)) 
                                                                                              vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_ApplyExpr_expr);
                                                                                            else 
                                                                                              if (((Record) vdm_TRF_uTAR_uDEF_fnpost).Is(vdm_TRF_uTAR_uEXPR_AllOrExistsExpr)) 
                                                                                                vdm_TRF_uTAR_uDEF_as_ufnpost = ((Record) vdm_TRF_uTAR_uDEF_fnpost).GetField(pos_TRF_uTAR_uEXPR_AllOrExistsExpr_expr);
                                                                                              else 
                                                                                                RunTime("Unknown record field selector");
        else 
          RunTime("A record was expected");
    ...
    Sequence tmpVar_159;
    tmpVar_159 = Sequence().ImpAppend(vdm_TRF_uTAR_uDEF_as_uparms);
    varRes_10.SetField(4, tmpVar_159);
  ...
  Record varRes_9(vdm_AS_ExplFnDef, length_AS_ExplFnDef);
  {
                    ...
                    if (((Record) (Record) vdm_TRF_uTAR_uDEF_parms[vdm_TRF_uTAR_uDEF_i.GetValue()]).Is(vdm_TRF_uTAR_uPAT_RecordPattern)) 
                      ...
                      if (((Record) (Record) vdm_TRF_uTAR_uDEF_parms[vdm_TRF_uTAR_uDEF_i.GetValue()]).Is(vdm_TRF_uTAR_uPAT_PatternName)) 
                        ...
                        if (((Record) (Record) vdm_TRF_uTAR_uDEF_parms[vdm_TRF_uTAR_uDEF_i.GetValue()]).Is(vdm_TRF_uTAR_uPAT_MatchVal)) 
                          ...
                          RunTime("Unknown record field selector");
          reselem_89 = vdm_TRF_uCAST_Pattern2Expr((Generic) par_90);
      ...
      for (int i_157 = bind_l_144.First(tmpe_158); i_157; i_157 = bind_l_144.Next(tmpe_158)) {
        ...
        if (succ_146) {
          ...
          if (((Record) vdm_TRF_uTAR_uDEF_res_uidents[vdm_TRF_uTAR_uDEF_i.GetValue()]).Is(vdm_TRF_uTAR_uPAT_PatternName)) 
            ...
            RunTime("Unknown record field selector");
          reselem_152 = vdm_TRF_uCAST_Pattern2Expr((Generic) par_153);
    ...
    if (((Record) vdm_TRF_uTAR_uDEF_res_upat).Is(vdm_TRF_uTAR_uPAT_TuplePattern)) 
      ...
      if (((Record) vdm_TRF_uTAR_uDEF_res_upat).Is(vdm_TRF_uTAR_uPAT_PatternName)) 
        ...
        RunTime("Unknown record field selector");
    vdm_TRF_uTAR_uDEF_in_uexpr = vdm_TRF_uCAST_Pattern2Expr((Generic) par_181);
