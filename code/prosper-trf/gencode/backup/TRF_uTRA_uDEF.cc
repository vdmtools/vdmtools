...
static TYPE_TRF_uTAR_uDEF_FnDef vdm_TRF_uTRA_uDEF_trv_uFnDef(const TYPE_AS_FnDef &);
static type_11AS_ValueDefCL vdm_TRF_uTRA_uDEF_trv_uGlobalValueDef(const type_11AS_ValueDefCL &);
...
static TYPE_TRF_uTAR_uDEF_TypeDef vdm_TRF_uTRA_uDEF_trv_uTypeDef(const TYPE_AS_TypeDef &);
...
TYPE_TRF_uTAR_uDEF_Definitions vdm_TRF_uTRA_uDEF_trv_uDefinitions(const TYPE_AS_Definitions &var_1_1) {
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 1" << endl;
  ...
  if (var_1_1.IsRecord() && vdm_AS_Definitions == var_1_1.GetTag()) {
    ...
    cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 2" << endl;
    if (succ_2 = 6 == (Int) e_l_41.Length()) {
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 3" << endl;
	vdm_TRF_uTRA_uDEF_typem = (Generic) e_l_41.Hd();
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 4" << endl;
	vdm_TRF_uTRA_uDEF_valuem = (Generic) e_l_41[2];
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 5" << endl;
	vdm_TRF_uTRA_uDEF_fnm = (Generic) e_l_41[3];
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 6" << endl;
	vdm_TRF_uTRA_uDEF_opm = (Generic) e_l_41[4];
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 7" << endl;
	vdm_TRF_uTRA_uDEF_stt = (Generic) e_l_41[5];
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 8" << endl;
	vdm_TRF_uTRA_uDEF_cid = (Generic) e_l_41[6];
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 9" << endl;
    }
  }
  else 
    succ_2 = false;

  cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 10" << endl;
  ...
  Record varRes_3(vdm_AS_Definitions, length_AS_Definitions);
  {
    ...
    {
	bool succ_12 = true;
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 11" << endl;
	  
	Set e1_set_15 = vdm_TRF_uTRA_uDEF_typem.Dom();
	cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 12" << endl;
	...
	Record vdm_TRF_uTRA_uDEF_nm(vdm_AS_Name, length_AS_Name);
	{
		...
		succ_12 = true;
		vdm_TRF_uTRA_uDEF_nm = elem_16;
		cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 13" << endl;
		...
		cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 14" << endl;

	    }
	}
    }
    cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 15" << endl;
    ...
    Map res_m_20;
    {
      ...
      Record vdm_TRF_uTRA_uDEF_nm(vdm_AS_Name, length_AS_Name);
      {
        ...
        for (int bb_31 = e1_set_29.First(tmpe_32); bb_31; bb_31 = e1_set_29.Next(tmpe_32)) {
          ...
          succ_26 = true;
	  vdm_TRF_uTRA_uDEF_nm = elem_30;
	  cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 16" << endl;
	  ...
	  cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 17" << endl;

        }
      }
    }
    cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 18" << endl;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uDefinitions 19" << endl;
...
TYPE_TRF_uTAR_uDEF_ExplFnDef vdm_TRF_uTRA_uDEF_trv_uExplFunction(const TYPE_AS_ExplFnDef &var_1_1) {
  ...
  bool succ_2 = true;
  cout << "vdm_TRF_uTRA_uDEF_trv_uExplFunction 1" << endl;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uExplFunction 2" << endl;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uExplFunction 3" << endl;

  varRes_3 = vdm_TRF_uTAR_uDEF_tar_uExplFunction((Generic) vdm_TRF_uTRA_uEXPR_trv_uNameName((Generic) vdm_TRF_uTRA_uDEF_nm),
						 (Generic) vdm_TRF_uTRA_uDEF_trv_uTypeVarList((Generic) vdm_TRF_uTRA_uDEF_tv_ul),
						 (Generic) vdm_TRF_uTRA_uTYPE_trv_uFnType((Generic) vdm_TRF_uTRA_uDEF_tp),
						 (Generic) vdm_TRF_uTRA_uDEF_trv_uParametersList((Generic) vdm_TRF_uTRA_uDEF_parms),
						 (Generic) vdm_TRF_uTRA_uDEF_trv_uFnBody((Generic) vdm_TRF_uTRA_uDEF_fnbody),
						 (Generic) par_14, (Generic) par_20,
						 (Generic) vdm_TRF_uTRA_uDEF_cid);
  cout << "vdm_TRF_uTRA_uDEF_trv_uExplFunction 4" << endl;
...
TYPE_TRF_uTAR_uDEF_FnBody vdm_TRF_uTRA_uDEF_trv_uFnBody(const TYPE_AS_FnBody &var_1_1) {
  ...
  Int vdm_TRF_uTRA_uDEF_cid;
  bool succ_2 = true;
  cout << "vdm_TRF_uTRA_uDEF_trv_uFnBody 1" << endl;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uFnBody 2" << endl;
  if (!succ_2) 
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uFnBody 3" << endl;
  return (Generic) varRes_3;
}
#endif
...
TYPE_TRF_uTAR_uDEF_FnDef vdm_TRF_uTRA_uDEF_trv_uFnDef(const TYPE_AS_FnDef &vdm_TRF_uTRA_uDEF_fndef) {
  cout << "vdm_TRF_uTRA_uDEF_trv_uFnDef 1" << endl;
  Record varRes_3(vdm_AS_ExplFnDef, length_AS_ExplFnDef);
  bool succ_4 = true;
  {
    succ_4 = true;
  ...
  if (!succ_4) 
    RunTime("No \'others\' branch in CasesExpr");
  cout << "vdm_TRF_uTRA_uDEF_trv_uFnDef 2" << endl;
  return (Generic) varRes_3;
}
#endif
...
TYPE_TRF_uTAR_uDEF_Module vdm_TRF_uTRA_uDEF_trv_uModule(const TYPE_AS_Module &var_1_1) {
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 8" << endl;
  Record varRes_3(vdm_AS_Module, length_AS_Module);
  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 9" << endl;
  Generic par_8;
  
  if (((Bool) (vdm_TRF_uTRA_uDEF_defs == Nil())).GetValue())
      {
	  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 10" << endl;
	  par_8 = Nil();
	  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 11" << endl;
      }
  else
      {
	  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 12" << endl;
	  par_8 = vdm_TRF_uTRA_uDEF_trv_uDefinitions((Generic) vdm_TRF_uTRA_uDEF_defs);
	  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 13" << endl;
      }
  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 14" << endl;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uModule 15" << endl;
...
TYPE_TRF_uTAR_uDEF_ParametersList vdm_TRF_uTRA_uDEF_trv_uParametersList(const TYPE_AS_ParametersList &vdm_TRF_uTRA_uDEF_parms) {
  Sequence varRes_3;
  cout << "vdm_TRF_uTRA_uDEF_trv_uParametersList 1" << endl;
  {
    Sequence res_l_4;
    Set resBind_s_6;
    Set riseq_10;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uParametersList 2" << endl;
  return (Generic) varRes_3;
}
#endif
...
TYPE_TRF_uTAR_uDEF_TypeVarList vdm_TRF_uTRA_uDEF_trv_uTypeVarList(const TYPE_AS_TypeVarList &vdm_TRF_uTRA_uDEF_tv_ulst) {
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uTypeVarList 1" << endl;
  {
    Sequence res_l_4;
    Set resBind_s_6;
    Set riseq_10;
  ...
  cout << "vdm_TRF_uTRA_uDEF_trv_uTypeVarList 2" << endl;
  return (Generic) varRes_3;
}
#endif
