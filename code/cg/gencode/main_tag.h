...
#define TAG_TYPE_SSENV_OpTypeRepElem       (TAG_SSENV + 22)
...
#define TAG_TYPE_PRETTY_PRINTER_SyncDef    (TAG_TYPE_PRETTY_PRINTER+7)
#define TAG_TYPE_PRETTY_PRINTER_ThreadDef  (TAG_TYPE_PRETTY_PRINTER+8)
#define TAG_TYPE_PRETTY_PRINTER_Traces     (TAG_TYPE_PRETTY_PRINTER+9)
...
#define TAG_TYPE_SEM_QUOTE             (TAG_TYPE_SEM + 13)
#define TAG_TYPE_SEM_TOKEN             (TAG_TYPE_SEM + 14)
#define TAG_TYPE_SEM_TUPLE             (TAG_TYPE_SEM + 15)
#define TAG_TYPE_SEM_UNDEF             (TAG_TYPE_SEM + 16)
#define TAG_TYPE_SEM_ValTp             (TAG_TYPE_SEM + 17)
#define TAG_TYPE_SEM_BlkEnv            (TAG_TYPE_SEM + 18)
#define TAG_TYPE_SEM_ExplFN            (TAG_TYPE_SEM + 19)
#define TAG_TYPE_SEM_ExplOP            (TAG_TYPE_SEM + 20)
#define TAG_TYPE_SEM_RETURN            (TAG_TYPE_SEM + 21)
#define TAG_TYPE_SEM_OBJ_uRef          (TAG_TYPE_SEM + 22)
#define TAG_TYPE_SEM_ExplPOLY          (TAG_TYPE_SEM + 23)
#define TAG_TYPE_SEM_CompExplFN        (TAG_TYPE_SEM + 24)
#define TAG_TYPE_SEM_OBJ               (TAG_TYPE_SEM + 25)
#define TAG_TYPE_SEM_History           (TAG_TYPE_SEM + 26)
#define TAG_TYPE_SEM_OverOPFN          (TAG_TYPE_SEM + 27)
...
#define TAG_TYPE_STKM_ObjectPattern    (TAG_STKM + 52)
#define TAG_TYPE_STKM_FieldPattern     (TAG_STKM + 53)
#define TAG_TYPE_STKM_ProcThread       (TAG_STKM + 54)
#define TAG_TYPE_STKM_PerThread        (TAG_STKM + 55)
#define TAG_TYPE_STKM_SpoThread        (TAG_STKM + 56)
...
#define TAG_quote_PUREOP     (DIV_OFFSET + 302)
