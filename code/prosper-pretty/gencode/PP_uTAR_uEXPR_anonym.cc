...
#if !DEF_type_cLcL2P && DECL_type_cLcL2P
#define DEF_type_cLcL2P 1

void type_cLcL2P::Init(TYPE_PP_uTAR_uEXPR_string p1, TYPE_PP_uTAR_uEXPR_string p2) {
  SetField(1, p1);
  SetField(2, p2);
}

TYPE_PP_uTAR_uEXPR_string type_cLcL2P::get_1() const { return (TYPE_PP_uTAR_uEXPR_string) GetField(1); }

void type_cLcL2P::set_1(const TYPE_PP_uTAR_uEXPR_string &p) { SetField(1, p); }

TYPE_PP_uTAR_uEXPR_string type_cLcL2P::get_2() const { return (TYPE_PP_uTAR_uEXPR_string) GetField(2); }

void type_cLcL2P::set_2(const TYPE_PP_uTAR_uEXPR_string &p) { SetField(2, p); }
#endif
