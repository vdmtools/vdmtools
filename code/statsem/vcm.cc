...
{
  switch(fndef.GetTag()) {
    case TAG_TYPE_AS_ExplFnDef:    { return fndef.GetSequence(pos_AS_ExplFnDef_tpparms); }
    case TAG_TYPE_AS_ImplFnDef:    { return fndef.GetSequence(pos_AS_ImplFnDef_params); }
    case TAG_TYPE_AS_ExtExplFnDef: { return fndef.GetSequence(pos_AS_ExtExplFnDef_params); }
    default:                       { return SEQ<TYPE_AS_TypeVar>();
    }
  }
}
