...
*  * FILE
*  *    $Source: /home/vdmtools/cvsroot/toolbox/code/specfile/rtf.h,v $
*  * VERSION
*  *    $Revision: 1.4 $
*  * DATE
*  *    $Date: 2006/03/24 01:59:55 $
*  * STATUS
*  *    $State: Exp $
*  * REFERENCES
*  *    
 ...
 *
 * Tokens that can't be classified are put in the L"unknown" class.
...
# define                rtfListLevel            74
# define                rtfListText             75
# define                rtfNewDestination       76
# define                rtfTwoEmbedded          77
# define                rtfUnicode              78
# define                rtfThemeData            79      // new in Word 2007
# define                rtfColorSchemeMapping   80      // new in Word 2007
# define                rtfLatentStyles         81      // new in Word 2007
# define                rtfDataStore            82      // new in Word 2007
# define                rtfFactoIdName          83      // new in Word 2007
# define		rtfMaxDestination	84	// highest dest + 1
...
# define                rtfFFLoMajor            8       // new in Word 2007
# define                rtfFFHiMajor            9       // new in Word 2007
# define                rtfFFDbMajor           10       // new in Word 2007
# define                rtfFFBiMajor           11       // new in Word 2007
# define                rtfFFLoMinor           12       // new in Word 2007
# define                rtfFFHiMinor           13       // new in Word 2007
# define                rtfFFDbMinor           14       // new in Word 2007
# define                rtfFFBiMinor           15       // new in Word 2007
...
# define		rtfACLowANSI		19
# define		rtfACHighANSI		20
# define		rtfACDoubleByte		21
...
struct RTFFont
{
	wchar_t	*rtfFName;		/* font name */
	wchar_t	*rtfFAltName;		/* font alternate name */
...
typedef	void (*RTFMsgFuncPtr) (wchar_t*); /* generic Msg function pointer */
typedef	void (*RTFPanicFuncPtr) (wchar_t*); /* generic Panic function pointer */
typedef	FILE * (*RTFOpenFileFuncPtr) (wchar_t*,wchar_t*); /* generic function pointer */

void RTFMsg (const std::wstring&);
void RTFPanic (const std::wstring&);

int		RTFReadCharSetMap (int);
void		RTFSetCharSetMap (wchar_t *, int);
int		RTFStdCharCode (const char *);
const char	*RTFStdCharName (int);
int		RTFMapChar (int);
int		RTFGetCharSet();
void		RTFSetCharSet(int);

/*wchar_t		*RTFGetLibPrefix();*/

/* The following defines are automatically generated.  Do not edit. */


/* These must be sequential beginning fro1m zero */
...
#define rtfCP_UnitedStatesIBM         437
#define rtfCP_ArabicASMO708           708
#define rtfCP_ArabicASMO449           709
#define rtfCP_ArabicTransparent       710
#define rtfCP_ArabicNafithaEnhanced   711
#define rtfCP_ArabicTransparentASMO   720
#define rtfCP_Windows31Western        819
#define rtfCP_IBMMultilingual         850
#define rtfCP_EasternEuropean         852
#define rtfCP_Portuguese              860
#define rtfCP_Hebrew                  862
#define rtfCP_FrenchCanadian          863
#define rtfCP_Arabic                  864
#define rtfCP_Norwegian               865
#define rtfCP_SovietUnion             866
#define rtfCP_Thai                    874
#define rtfCP_Japanese                932
#define rtfCP_SimplifiedChinese       936
#define rtfCP_Korean                  949
#define rtfCP_TraditionalChinese      950
#define rtfCP_Windows31Eastern       1250
#define rtfCP_Windows31Cyrillic      1251
#define rtfCP_WesternEuropean        1252
#define rtfCP_Greek                  1253
#define rtfCP_Turkish                1254
#define rtfCP_Hebrew2                1255
#define rtfCP_Arabic2                1256
#define rtfCP_Baltic                 1257
#define rtfCP_Vietnamese             1258
#define rtfCP_Johab                  1361
#define rtfCP_
