...
c2.C`pre_f(8))",
     <FunctionApplication>,
     [ mk_AS`Name( [ "f" ], 41943284 ) ],
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt13" ], 41943275 ) ) ),
  mk_TEST`ProofObligationPP(
     "(exists dummy : nat &
A`post_MetA1(dummy))",
     <Satisfiability>,
...
InvokeStmtTest`post_InvokeStmt1(dummy))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt1" ], 41943153 ) ) ),
  mk_TEST`ProofObligationPP(
     "(exists dummy : nat &
InvokeStmtTest`post_InvokeStmt7(dummy))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt7" ], 41943210 ) ) ),
  mk_TEST`ProofObligationPP(
     "(exists dummy : bool &
InvokeStmtTest`post_InvokeStmt9(dummy))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt9" ], 41943236 ) ) ),
  mk_TEST`ProofObligationPP(
     "(exists dummy : nat &
InvokeStmtTest`post_InvokeStmt11(dummy))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt11" ], 41943247 ) ) ),
  mk_TEST`ProofObligationPP(
     "(exists dummy : real &
InvokeStmtTest`post_InvokeStmt8(dummy))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt8" ], 41943224 ) ) ),
  mk_TEST`ProofObligationPP(
     "(forall arg : nat &
(exists dummy : A &
...
InvokeStmtTest`post_InvokeStmt12(b2, dummy)))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt12" ], 41943259 ) ) ),
  mk_TEST`ProofObligationPP(
     "(forall d : nat &
(exists dummy : nat &
InvokeStmtTest`post_InvokeStmt2(d, dummy)))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt2" ], 41943170 ) ) ),
  mk_TEST`ProofObligationPP(
...
InvokeStmtTest`post_InvokeStmt3(arg, dummy)))",
     ...
     mk_POGTP`LocContext(
        <operations>,
        mk_AS`Name( [ "InvokeStmtTest" ], 41943131 ),
        mk_AS`Name( [ "InvokeStmt3" ], 41943190 ) ) ) }
