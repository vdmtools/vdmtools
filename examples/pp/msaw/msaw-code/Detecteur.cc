...
vdm_Detecteur::vdm_Detecteur() { RegisterAsDerived(vdm_GetId()); }

void vdm_Detecteur::vdm_Init(const ObjectRef &vdm_radar_uinformation, const ObjectRef &vdm_view) { vdm_pistes_uradar = vdm_radar_uinformation; }

void vdm_Detecteur::vdm_CalculeRisque(const ObjectRef &vdm_segment_ude_uprediction, const ObjectRef &vdm_obstacle) {
